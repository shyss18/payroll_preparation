...
{
    public class AddHourlyEmployeeUnitTests
    {
        ...
        public AddHourlyEmployeeUnitTests()
        {
        ...
        public async Task Handle_CreateHourlyEmployee()
        {
            ...
            var command = _fixture.Create<AddHourlyEmployeeCommand>();
            var commandHandler = _autoMocker.CreateInstance<AddHourlyEmployeeCommandHandler>();
